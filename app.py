...
def uploaded_file(filename):
    j =  send_from_directory(app.config['UPLOAD_FOLDER'], filename)
    print(j)
    load_pdf(file_path="C:\\Users\ASUS\Downloads\\"+j)
    return j
...
# pdf_text = load_pdf(file_path="C:\\Users\ASUS\Downloads\\"+j)
...
def make_prompt(query, relevant_passage):
  ...
  If the passage is irrelevant to the answer, you may ignore it.
    You must ask 3-5 insightful questions related to the given data
            You must also ensure that you cite the source of the information along with the page and line number "
